...
class VisionAssistant:
    def __init__(self, debug_mode=False):
        ...
        self.scene_classifier = tf.keras.models.load_model('best_model.keras')  # Same as test script
    ...
    def process_frame(self, frame):
        ...
        return self.generate_description(scene_type, objects, depth_map)
    ...
    def process_image(self, image_path):
        ...
        # Save the output image for your report
        output_path = os.path.join(self.debug_dir, "output_with_boxes.jpg")
...
if __name__ == '__main__':
    ...
    #test_images\downloadm.jpeg
    #test_images\VideoCapture_20250521-150146.jpg
    #test_images\WhatsApp Image 2025-08-06 at 14.54.07_5c252afd.jpg
    assistant.process_image("test_images\WhatsApp Image 2025-08-06 at 14.54.07_5c252afd.jpg")
    # assistant.process_images_folder("test_images")